    ...
    try:
        completion = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "Ты — технический редактор. Твоя задача: оформить текст пользователя в красивый список."
                    "СТРОГО ЗАПРЕЩЕНО сокращать технические характеристики (процессор, видеокарта, память и т.д.). "
                    "Выпиши их все через буллиты '•'. "
                    "Если в исходном тексте есть подробности про тесты в играх или ФПС — обязательно оставь их."
                },
                {
                    "role": "user",
